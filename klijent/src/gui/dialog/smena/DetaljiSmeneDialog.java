...
public class DetaljiSmeneDialog extends javax.swing.JDialog {
    ...
    public DetaljiSmeneDialog(Frame parent, boolean modal, Smena smena, SmenaDialog dialog) {
        super(parent, modal);
        initComponents();
    ...
    private void btnSacuvajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSacuvajActionPerformed
        try {
            smena.setPocetak(Integer.parseInt(txtPocetak.getText()));
            smena.setKraj(Integer.parseInt(txtKraj.getText()));

            if (SmenaKontroler.getInstanca().azurirajSmenu(smena)) {
                JOptionPane.showMessageDialog(this, "Sistem je azurirao smenu", "Uspeh", JOptionPane.INFORMATION_MESSAGE);
                this.dispose();
                dialog.popuniTabelu();
            } else {
                JOptionPane.showMessageDialog(this, "Sistem ne moze da azurira smenu", "Greska", JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void popuniPodatke() {
        txtPocetak.setText(String.valueOf(smena.getPocetak()));
        txtKraj.setText(String.valueOf(smena.getKraj()));
    }
