...
public class DetaljiRasporedaDialog extends javax.swing.JDialog {
    ...
    public DetaljiRasporedaDialog(Frame parent, boolean modal, Raspored raspored, RasporedDialog dialog) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Detalji učitanog rasporeda"));

        jLabel1.setText("Datum:");

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Angažovanja za učitani raspored"));
        ...
        txtRaspored.setFocusable(false);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtRaspored, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void popuniRaspored() {
        txtRaspored.setText(raspored.toString());
    }
    ...
    private void popuniTabelu() {
        ...
        List<Angazovanje> filter = new ArrayList<>();
        for (Angazovanje a : angazovanja) {
            if (a.getRaspored().getDatum().equals(raspored.getDatum())) {
                filter.add(a);
            }
        }

        AngazovanjeTableModel atm = new AngazovanjeTableModel(filter);
